<template>
    <div class="v_slider">
        ...
        <ul v-if="dots" class="v_slider__dots">
            <li v-for="n in numDot" :key="n.id" @click="setDot(n)" :class="{'active': n == numDotActive}">
                <span></span>
            </li>
        </ul>
...
<style>
    ...
    .v_slider__prev,
    .v_slider__next { outline: none; background:transparent; padding: 10px 15px; margin: 2px; border:1px solid #ff3f4d; color:#ff3f4d; font-size: 20px; opacity: 0.9; }
